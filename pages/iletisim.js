          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center justify-between h-20">
              ...
              <nav className="hidden md:flex items-center space-x-1">
                ...
                <Link href="/iletisim" className="px-4 py-2 text-sm font-medium text-white bg-white/20 rounded-lg backdrop-blur-sm">
                  İletişim
                </Link>
              </nav>
            ...
            {mobileMenuOpen && (
              <div className="md:hidden py-4 border-t border-white/10">
                <nav className="flex flex-col space-y-1">
                  ...
                  <Link href="/iletisim" className="px-4 py-3 text-sm font-medium text-white bg-white/20 rounded-lg">
                    İletişim
                  </Link>
                </nav>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              ...
              <div className="text-center">
                ...
                <nav className="flex flex-wrap justify-center gap-x-6 gap-y-2">
                  <Link href="/" className="text-sm text-blue-200 hover:text-white transition-colors">Fiyatlar</Link>
                  <Link href="/piyasalar" className="text-sm text-blue-200 hover:text-white transition-colors">Piyasalar</Link>
                  <Link href="/alarms" className="text-sm text-blue-200 hover:text-white transition-colors">Alarmlar</Link>
                  <Link href="/iletisim" className="text-sm text-blue-200 hover:text-white transition-colors">İletişim</Link>
                </nav>
              </div>
